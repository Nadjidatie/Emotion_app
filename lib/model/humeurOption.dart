...
/// Catalogue des humeurs proposées dans le questionnaire.
/// Sert aussi à reconstruire l'icône/couleur d'une humeur sauvegardée.
class HumeurCatalogue {
  ...
  // Humeurs négatives (valeurs basses)
  ...
  /// Ordre d'affichage : positives d'abord, puis négatives.
  ...
  /// Moyenne pondérée des valeurs des humeurs sélectionnées.
  ///
