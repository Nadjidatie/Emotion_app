...
/// Carte qui affiche la phase courante du cycle.
///
/// S'abonne au [CycleService] (ChangeNotifier) — quand l'utilisatrice change
/// la date de ses dernières règles dans les réglages, ou enregistre un nouveau
/// log, la carte se met à jour automatiquement.
class CurrentPhaseCard extends StatefulWidget {
  final VoidCallback? onTapQuestionnaire;

  const CurrentPhaseCard({super.key, this.onTapQuestionnaire});

  @override
  State<CurrentPhaseCard> createState() => _CurrentPhaseCardState();
}

class _CurrentPhaseCardState extends State<CurrentPhaseCard> {
  @override
  void initState() {
    super.initState();
